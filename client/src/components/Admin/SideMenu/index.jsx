    ...
    return (
      <div>
        <div className="sideContainer">
          <label className="imageUpload--profile" style={avatarImg}>
            <input
              onInputCapture={e => {
          ...
          <ul className="sideContainer__menu">
            ...
            <li className="sideContainer__menu__item">
              <Link to={`/dashboard/how-it-works`}>How it works</Link>
            </li>
            <li className="sideContainer__menu__item">
            ...
            <li
              className="sideContainer__menu__item"
              onClick={e => this.auth.logout(e)}
            >
              <a>Log Out </a>
            </li>
          </ul>
